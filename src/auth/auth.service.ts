...
export class AuthService {
    ...
    async signIn(username: string, password:string): Promise<{ token: string, expiry: number }> {
        const user = await this.userService.findUser(username);
    ...
    async signup(username: string = "john", password: string ="test", role: string ="arole") {
